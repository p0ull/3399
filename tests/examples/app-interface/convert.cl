...
__kernel void nv12gbr(__write_only image2d_t destinationImage, __global uchar * yuv)
{
	...
	float4 colour=(float4)(r,g,b,1)*(float4)(1/255.0);
    
  //  if(y!=16)
 //printf("%d %d %d %d | %d %d %d|%f %f %f\n",W,H,i,j,y,u,v,colour.x,colour.y,colour.z,colour.w);
