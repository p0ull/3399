...
unsigned char rgbbuffer[1920*1080*3];

int main()
{
    FILE *fp=fopen("nv12","r");
    fread(yuvbuffer,1,sizeof(yuvbuffer),fp);
    fclose(fp);
   InitLookupTable();
   InitConvertTable();
   ...
   ConvertYUV2RGB(yuvbuffer,yuvbuffer+1920*1080,yuvbuffer+1920*1080/4,rgbbuffer,1920,1080);
